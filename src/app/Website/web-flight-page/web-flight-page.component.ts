...
@Component({
  selector: 'app-web-flight-page',
  templateUrl: './web-flight-page.component.html',
  styleUrls: ['./web-flight-page.component.scss']
})
export class WebFlightPageComponent implements OnInit {
  CityData: any;
  Flightdata: any;
